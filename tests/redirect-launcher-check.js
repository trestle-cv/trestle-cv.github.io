...
assert(html.includes('data-product="trestle"'),'generated redirect page missing product id');
assert(html.includes('data-default-port="7333"'),'generated redirect page missing default port');
...
console.log('trestle redirect launcher check: ok');
